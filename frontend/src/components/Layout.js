...
const Layout = ({ children }) => {
  ...
  const navigation = user?.role === 'student' ? [
    ...
    { name: 'Mark Attendance', href: '/attendance', icon: ClipboardDocumentListIcon },
          ...
          <div className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
            ...
            <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
              <div className="flex flex-shrink-0 items-center px-4">
                <span className="text-xl font-bold text-primary-600">📍 Attendance</span>
              </div>
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
          ...
          <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
            <div className="group block w-full flex-shrink-0">
              ...
              <button
                onClick={handleLogout}
                className="mt-2 group flex w-full items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md"
              >
                <ArrowRightOnRectangleIcon className="mr-3 h-5 w-5" />
                Sign out
              </button>
